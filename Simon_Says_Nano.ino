...
#define LED_CTRL_B  15
#define LED_CTRL_G  16
#define LED_CTRL_R  17
...
void setup() 
{
  ...
  pinMode(dip_D_1, INPUT);
  pinMode(dip_D_2, INPUT);
  pinMode(dip_D_3, INPUT);
  pinMode(dip_D_4, INPUT);
  pinMode(dip_D_5, INPUT);
  ...
  bits[1] = digitalRead(dip_D_1);
  bits[2] = digitalRead(dip_D_2);
  bits[3] = digitalRead(dip_D_3);
  bits[4] = digitalRead(dip_D_4);
  bits[5] = digitalRead(dip_D_5);
  bits[6] = digitalRead(dip_D_6);
  //bits[7] = digitalRead(dip_D_7);
  bits[7] = analogRead(dip_7) > 1000 ? true : false;
